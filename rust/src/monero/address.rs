...
mod tests {
    ...
    fn test_stagenet_address_format() {
        ...
        assert!(address.starts_with('5'), "Stagenet address must start with '5', got: {}", address);
        assert_eq!(address.len(), 95, "Address should be 95 chars, got: {}", address.len());
    }
    ...
    fn test_mainnet_address_format() {
        ...
        assert!(address.starts_with('4'), "Mainnet address must start with '4', got: {}", address);
        assert_eq!(address.len(), 95, "Address should be 95 chars, got: {}", address.len());
    }
    ...
    fn test_address_roundtrip() {
        ...
        assert!(parsed.is_ok(), "Address should parse back (validates checksum): {}", address_str);
    }
