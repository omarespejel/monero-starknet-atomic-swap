...
mod e2e_dleq_tests {
    ...
    fn get_real_msm_hints() -> (
        ...
        // Regenerated DLEQ hints with correct scalar truncation (regenerate_dleq_hints.py)
        // CRITICAL: Scalars are truncated to u128 before mod order (matching Cairo's reduce_felt_to_scalar)
        // s_hint_for_g: Fake-GLV hint for s·G (response scalar truncated to u128)
        ...
        // s_hint_for_y: Fake-GLV hint for s·Y (response scalar truncated to u128)
