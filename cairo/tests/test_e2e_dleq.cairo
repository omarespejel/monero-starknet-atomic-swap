...
mod e2e_dleq_tests {
    ...
    fn test_e2e_dleq_rust_cairo_compatibility() {
        ...
        // Fake-GLV hint for adaptor point MSM: scalar·G == adaptor_point
        // Generated by tools/generate_adaptor_point_hint.py using get_fake_glv_hint()
        // Format: [Q.x[4], Q.y[4], s1, s2_encoded] where:
        //   - Q = scalar·G = adaptor_point (computed from hashlock scalar)
        //   - s1, s2_encoded satisfy s2·scalar ≡ s1 (mod Ed25519_order)
        // This hint has CORRECT s1/s2 decomposition (not dummy values)
        // Generated from hashlock scalar: 0xdca1df105145b9c5f28931b418eab140b6574f798511d02fa11ffa68e5e3f23
        let fake_glv_hint = array![
            ...
            0x0,                                  // Q.y limb3
            0x1ee8cf4a93273d5d736b6cd2e6cdf459,   // s1 (correct decomposition)
            0x11b124affb5eddd13ca138b2665224218   // s2_encoded (correct decomposition)
        ].span();
